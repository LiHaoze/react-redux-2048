...
class Game extends Component {
  static propTypes = {
    ...
    addScoreToScorelist: PropTypes.func.isRequired,
  ...
  checkGameStatus () {
    if (!this.isMovable()) {
      // game over
      this.props.addScoreToScorelist(this.props.score);
...
const mapDispatchToProps = (dispatch) => {
  return {
    ...
    addScoreToScorelist: score => dispatch(actions.addScoreToScorelist(score))
  };
};
